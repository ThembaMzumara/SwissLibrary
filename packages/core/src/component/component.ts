...
> extends BaseComponent<P, S> {
  ...
  public initialize(): void {
    ...
    console.log('[Component] Inside initialize() for', this.constructor.name);
  ...
  public setupReactivity(): void {
    ...
    console.log('[Component] setupReactivity() called for', this.constructor.name);
  ...
  public performUpdate(): void {
    try {
      ...
      if (this._container) {
        ...
        updateDOMNode((this._vnode as any).dom, newVNode);
        this._vnode = newVNode;
      }
  ...
  public mount(container: HTMLElement): void {
    ...
    // Set container first so it's available when the effect runs
    this._container = container;

    // Ensure initialized (for root components)
    // This will call setupReactivity() which creates an effect that triggers performUpdate()
    this.initialize();

...
This repository hosts the SwissJS framework, compiler, CLI, plugins, and docs.

**File Extensions:**
- `.ui` - Compiled Swiss files (Swiss syntax + TypeScript)
- `.uix` - Compiled Swiss files with JSX (Swiss syntax + TypeScript + JSX)
